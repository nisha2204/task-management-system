    ...
    return (
      ...
      //     if (error) return `Error! ${error.message}`;
          ...
          <div className="teams">
            ...
            <div className="list">
          {teams.map((team, {col = randomColor()}) => (
            // <div className="teams">
              <div className="item" >
                <div className="head">
                  <h4 className="team-name">{team.teamName}</h4>
                  <p className="team-members">Total Members: {team.teamMembers}</p>
                </div>
                <div className="mid">
                  <div className="top">
                    <h5 className="project-name" style={{color:`${col}`,backgroundColor:`${col}22`, width:`${len(team.projectName)}`}}>{team.projectName}</h5>
                ...
                <div className="bottom">
                  ...
                  <div className="members">
                    {team.list.map((item, {avatar = randomAvatar()}) => ( 
                    <div className="member">
                      <div className="img-container">
                        <img src={avatar} alt="member" />
                      </div>
                      <div className="info">
                        <h5 className="name">nayan</h5>
